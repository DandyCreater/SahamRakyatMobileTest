class FoodDetailEntity {
  List<MealsFoodDetailEntity>? meals;

  FoodDetailEntity({required this.meals});
}

class MealsFoodDetailEntity {
  String? idMeal;
  String? strMeal;
  ...
  factory MealsFoodDetailEntity.fromJson(Map<String, dynamic> json) {
